...
Using an LLM or any other tool to prepare a change is fine and nothing to hide; say so in the pull request
if you like. What lands in the repo is judged on the diff and on who stands behind it: a tool is not a
contributor and gets no co-author trailers or "generated by" comments. See *Tools used* in the README for how
